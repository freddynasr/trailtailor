...
import { UsersWithAgencyProjectPermissionsSidebarOptions } from "@/lib/types";
import CustomModal from "@/components/global/custom-modal";

export const columns: ColumnDef<UsersWithAgencyProjectPermissionsSidebarOptions>[] =
  [
    {
      accessorKey: "id",
      header: "",
...
interface CellActionsProps {
  rowData: UsersWithAgencyProjectPermissionsSidebarOptions;
}
              ...
              setOpen(
                <CustomModal
                  ...
                  <UserDetails
                    ...
                    projects={rowData?.Agency?.Project}
                    userData={rowData}
                  />
                </CustomModal>
                // async () => {
