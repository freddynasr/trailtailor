...
const page = async ({ params }: Props) => {
  ...
  const tempaddOns = await stripe.products.list({
    ids: addOnProducts.map((product) => {
      return product.id;
    }),
    expand: ["data.default_price"],
  });
  const addOns = tempaddOns.data.filter((product) => product.active);
