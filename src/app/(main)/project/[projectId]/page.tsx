...
import WorkflowValue from "@/components/global/workflow-value";
import ProjectWebsiteChart from "@/components/global/project-website-chart";
...
const ProjectPageId = async ({ params, searchParams }: Props) => {
  ...
  const websitePerformanceMetrics = websites.map((website) => ({
    ...website,
    totalWebsiteVisits: website.WebsitePages.reduce(
      ...
      <div className="relative h-full">
        ...
        <div className="flex flex-col gap-4 pb-6">
          <div className="flex gap-4 flex-col xl:!flex-row">
            ...
            <WorkflowValue projectId={params.projectId} />
          ...
          <div className="flex gap-4 flex-col xl:!flex-row">
            <Card className="relative">
              <CardHeader>
                <CardDescription>Website Performance</CardDescription>
              </CardHeader>
              <CardContent className=" text-sm text-muted-foreground flex flex-col gap-12 justify-between ">
                <ProjectWebsiteChart data={websitePerformanceMetrics} />
                <div className="lg:w-[150px]">
                  Total page visits across all websites. Hover over to get more
                  details on website page performance.
                </div>
              </CardContent>
              <Contact2 className="absolute right-4 top-4 text-muted-foreground" />
            </Card>
