...
import { FontFamilyCombobox } from "@/components/global/FontFamilyComboBox";
        ...
        <AccordionContent className="flex flex-col gap-2 ">
          <div className="flex flex-col gap-2 ">
            <div className="text-muted-foreground">
              Please append “px”, “%”, or “rem” after the numeric value.
            </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex border-[1px] rounded-md overflow-clip items-center">
              <div
                className="w-12 h-10"
                style={{
                  backgroundColor:
        ...
        <AccordionContent className="flex flex-col gap-4">
          <div>
            <div className="text-muted-foreground mb-2">
              {/* do the same with the background image tell them to put it in url()*/}
              Please wrap your background image in url().
            </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Switch
                ...
                id="flexDirection"
                checked={
                  state.editor.selectedElement.styles.flexDirection === "row"
                }
                onCheckedChange={(va) => {
                  handleOnChanges({
                    target: {
